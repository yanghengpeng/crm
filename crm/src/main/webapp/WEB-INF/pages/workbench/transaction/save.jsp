...
<script type="text/javascript">
	$(function () {
		...
		$("#create-accountName").typeahead({
			source:function(jquery, process){ //每次键盘弹起，自动触发这个函数，可以向后台发送请求，从数据库中查数据给数据源
				...
				$.ajax({
					...
					type:"post",
					data:{
						customerName:jquery   //jquery就是我们输入的关键字
					},
					dataType:"json",
					success:function(data){   //['xxxx','xxxx','xxx','xxxx']
						process(data);
					}
				})
			}
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
			  <select class="form-control" id="create-transactionStage">
				  <option></option>
				  <c:forEach items="${transactionStageList}" var="stage">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-clueSource">
				  <option></option>
					<c:forEach items="${transactionSourceList}" var="source">
			...
			<div class="col-sm-10" style="width: 300px;" >
				<input type="hidden" id="create-activityId" value="22c43cdf3e994f90a95a23968f104ddb">
				<input type="text" class="form-control" id="create-activityName" value="测试04">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;" >
				<input type="hidden" id="create-contactsId" value="28b3e2f2edbc48d8b8cb23ee08def791">
				<input type="text" class="form-control" id="create-contactsName" value="杨恒鹏">
			</div>
		</div>
