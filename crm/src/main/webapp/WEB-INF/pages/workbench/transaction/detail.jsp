...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		阶段&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<%--遍历stageList，依次显示每个阶段对应的图标--%>
		<c:forEach items="${stageValueList}" var="stage">
			<%--判断当前阶段stage就是当前交易所处阶段，则图标显示为map-marker，颜色显示为绿色--%>
			...
			<%--判断当前阶段stage是当前交易所处阶段之前，则图标显示为ok-circle，颜色显示为绿色--%>
...
<%--		<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="资质审查" style="color: #90F790;"></span>
	...
	<div style="position: relative; top: 100px; left: 40px;">
        ...
        <c:forEach items="${tranRemarkList}" var="tranRemark">
			<div class="remarkDiv" id="${tranRemark.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">交易</font> <font color="gray">-</font> <b>${tranRemark.name}</b> <small style="color: gray;"> ${tranRemark.editFlag == '0'?tranRemark.createTime:tranRemark.editTime} 由${tranRemark.editFlag == '0'?tranRemark.createBy:tranRemark.editBy}${tranRemark.editFlag == '0'?'创建':'修改'}</small>
					<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
						<a class="myHref" name="editA" tranRemark="${tranRemark.id}" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="myHref" name="deleteA" tranRemark="${tranRemark.id}" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
					</div>
				</div>
			</div>
		</c:forEach>
