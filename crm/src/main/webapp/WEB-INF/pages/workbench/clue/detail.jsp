...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#bundActivityBtn").click(function () {
			//初始化工作 1、清空搜索框  2、清空搜索市场活动的列表
			$("#searchActivityTxt").val("");
			$("#tBody").html("");

			//弹出"线索关联市场活动的模态窗口"模态窗口
		...
		$("#searchActivityTxt").keyup(function () {
			...
			var clueId = '${clue.id}';   //在JavaScript中写EL表达式，必须添加引号(单/双引号)
			//发起请求
			$.ajax({
		...
		$("#saveBundActivityBtn").click(function () {
			...
			//获取每一个checkbox上绑定的市场活动id
			var ids = "";
			$.each(checkedIds,function () { //activityId=**&activityId=**..........
				ids += "activityId=" + this.value + "&";
			})
			ids += "clueId=${clue.id}";  ////activityId=**&activityId=**..........&clueId=....
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<c:forEach items="${remarkList}" var="remark">
			<div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
				<img title="${clue.createBy}" src="image/user-thumbnail.png" style="width: 30px; height:30px;">
				<div style="position: relative; top: -40px; left: 40px;" >
